...
public class GeneticAlgorithm {
    ...
    public static void resolve(int numCities,int[][] map, float mortalityRate, int evolutionNumber, boolean showcaseEvolution){
        ...
        for (int i = 0; i < evolutionNumber; i++) {
                renovateChromosomes(chromosomePopulation, results, mortalityRate);
                calculateResults(chromosomePopulation, results, map);
                orderResults(chromosomePopulation, results);
                if (showcaseEvolution) {
    ...
    public static void renovateChromosomes(int[][] chromosomes, int[] results, float mortalityRate) {

            int excludedStart = (int) (mortalityRate * 10);

            int i, i2 = 0;

            for (i = excludedStart; i < 10; i++) {
